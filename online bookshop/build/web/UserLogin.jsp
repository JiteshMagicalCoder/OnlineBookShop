...
<div class="wrapper row1">
 ...
 <!-- / Right Column --> 
        ...
        <div>
          ...
          <center>
        <caption><h3><font color="blue">User Login</font></h3></caption>
        <br><form action="LoginServlet" method="post">
            <table>
                <tr>
                     <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         Username:</td><td><input type="email" maxlength="30" name="username" autocomplete=on>
                        <font color=red size=1>Maximum 30 characters</font> <br><br></td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Password:</td><td><input type=password maxlength="30" name="password"></input>
                        <font color=red size=1>Maximum 30 characters</font><br><br></td>
                </tr>
               ...
               <br>
               <a href='Registration.jsp'><font size=2>Sign Up</font></a>   
  ...
  <div id="copyright" class="clear"> 
      ...
      <p class="fl_left">Copyright &copy; 2015 - All Rights Reserved - <a href="#">sanjay kumar pandey</a></p>
        ...
        <a href="view.jsp">hhg</a>     
<a href="Feedback.jsp">hhg</a> 
<a href="Address.jsp">hhg</a> 
<a href="AddBook.jsp">hhg</a> 
</body>
</html>