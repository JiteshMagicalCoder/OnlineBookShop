...
<div class="wrapper row1">
 ...
 <!-- / Right Column --> 
        ...
        <div>
            ...
            <center>
        <caption><h3><font color="blue">Admin Login</font></h3></caption>
        <br><form action="AdminServlet" method="post">
            
            <table>
                <tr>
                     <td>Username:</td><td><input type=email maxlength="30" name="username" autocomplete=on>
                        <font color=red size=1>Maximum 30 characters</font> <br><br></td>
                </tr>
                <tr>
                    <td>Password:</td><td><input type=password maxlength="30" name="password"></input>
                        <font color=red size=1>Maximum 30 characters</font><br><br></td>
                </tr>
