...
<div class="wrapper row1">
 ...
 <!-- / Right Column --> 
        ...
        <div>
         ...
         <center><img src="image/academic/communication.jpg" width=40%><input type="hidden" name="cl" value="communication"><br>communication<br>Rs. 280<br>
  ...
  <div class="rounded">
    <footer id="footer" class="clear"> 
      ...
      <div class="one_third">
        ...
        <i class="fa fa-envelope-o pright-10"></i> <a href="http/gmail.com">pandeysanjya092@gmail.com</a>
        </address>
      </div>
      <div class="one_third">
