...
<div class="wrapper row1">
 ...
 <!-- / Right Column --> 
        ...
        <input type="text" >
         ...
         <br><br><form action="Transaction.jsp" method="post">
         <table>
             <tr><td><img src="image/spiderman.jpg" width=40%><br>spider man<br>price 5$<br><input type="submit" value="buy" onclick="throw"></a><br></td>
