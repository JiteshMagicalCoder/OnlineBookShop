...
<div class="wrapper row1">
 ...
 <!-- / Right Column --> 
        ...
        <div>
            ...
            <center>
                <h3>Add Book</h3></center>
        <br><form action="BookAddServlet" method="post">
            <table>
                <tr><td>book name:</td><td><input type="text" maxlength="30" name="bookname" autocomplete="on"></td></tr>
                       
             
                <tr><td>author name:</td><td><input type="text" maxlength="30" name="authorname" autocomplete="on"></td></tr>
                        
                <tr><td>price:</td><td><input type="text" maxlength="10" name="price" autocomplete="on"></td></tr>
