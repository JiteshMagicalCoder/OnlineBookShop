 ...
 <!-- / Right Column --> 
        ...
        <div>
         ...
         <form action="addcart" method="get">
             <center><img src="image/competitive/fciBiology.jpg" width=40%><input type="hidden" name="cl" value="fciBiology"><br><br>Fci Assistant grade<br>biology<br>Rs. 140<br>
  ...
  <div id="copyright" class="clear"> 
    ...
    Document   : cart41
    Created on : Jan 5, 2016, 9:52:24 AM
    Author     : user
--%>
